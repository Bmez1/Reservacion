...
using ReservaHotel.Infrastructure.Adapters;
using ReservaHotel.Infrastructure.Ports;

namespace ReservaHotel.Infrastructure.Extensions;
...
public static class AutoLoadServices
{
    ...
    {
        // generic repository
        services.AddTransient(typeof(BaseRepositoryGeneric<>), typeof(GenericRepository<>));
